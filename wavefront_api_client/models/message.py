...
class Message(object):
    ...
    def __init__(self, attributes=None, severity=None, source=None, scope=None, id=None, target=None, content=None, title=None, start_epoch_millis=None, end_epoch_millis=None, display=None, read=None):  # noqa: E501
