...
class ResponseContainerMapStringInteger(object):
    ...
    @property
    def status(self):
        """Gets the status of this ResponseContainerMapStringInteger.  # noqa: E501


        :return: The status of this ResponseContainerMapStringInteger.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this ResponseContainerMapStringInteger.


        :param status: The status of this ResponseContainerMapStringInteger.  # noqa: E501
        :type: ResponseStatus
        """
        if status is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseContainerMapStringInteger, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseContainerMapStringInteger):
            return False
