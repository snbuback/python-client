...
class SettingsApi(object):
    ...
    def get_all_permissions(self, **kwargs):  # noqa: E501
        ...
        Returns all permissions' info data  # noqa: E501
    ...
    def get_all_permissions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/customer/permissions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='list[BusinessActionGroupBasicDTO]',  # noqa: E501
    ...
    def get_customer_preferences(self, **kwargs):  # noqa: E501
        """Get customer preferences  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customer_preferences(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customer_preferences_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_customer_preferences_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_customer_preferences_with_http_info(self, **kwargs):  # noqa: E501
        """Get customer preferences  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customer_preferences_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customer_preferences" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/customer/preferences', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='CustomerPreferences',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_default_user_groups_with_http_info(self, **kwargs):  # noqa: E501
        """Get default user groups customer preferences  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_default_user_groups_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_default_user_groups" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/customer/preferences/defaultUserGroups', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ResponseContainerListUserGroup',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_customer_preferences_with_http_info(self, **kwargs):  # noqa: E501
        """Update selected fields of customer preferences  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_customer_preferences_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_customer_preferences" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v2/customer/preferences', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
