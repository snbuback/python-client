...
*IntegrationApi* | [**get_all_integration_0**](docs/IntegrationApi.md#get_all_integration_0) | **GET** /api/v2/integration/installed | Gets a flat list of all Integrations that are installed, along with their status
